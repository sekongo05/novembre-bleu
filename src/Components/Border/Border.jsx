    ...
    return <>
                <div  className="border w-full h-screen  border-white flex justify-center flex-col items-center">
                   <div className=" border-white w-full h-screen bg-[url(/Images/p3.jpg)] bg-cover  flex bg-center flex-col  gap-y-40 sm:gap-0 items-center overflow-scroll">
                        <div  className=" border-red-200  flex justify-center items-center mb-[-50px] sm:mb-[100px] text-xl sm:text-6xl font-extrabold w-full h-[200px] sm:h-[300px] "> 
                            <p id='texte' className='border text-center  text-white rounded-2xl p-6 '>En bleu, unis contre le cancer de la prostate</p>
                        </div>
